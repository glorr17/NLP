...
#### http://www.tensorflow.org/, or https://github.com/jtoy/awesome-tensorflow). To ask
...
#### the Normal Equation (θ = ( X T · X )–1 · X T · y ; see Chapter 4). Finally, the code creates a
